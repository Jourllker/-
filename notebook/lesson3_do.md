...
![RAG overview](./images/lesson3/RAG_overview.png)
...
![alt text](images/lesson3/30gpu.png)
...
```bash
# 填入问题
sed -i '74s/.*/    queries = ["huixiangdou是谁开发的", "茴香豆怎么用了什么技术", "终于下班啦！"]/' /root/huixiangdou/huixiangdou/main.py
...
![](./images/lesson3/huixiangdou.png)

![](./images/lesson3/install.png)

`InternLM2-Chat-7B` 的关于 `huixiangdou` 问题的原始输出：

![](./images/lesson3/internlm27b.png)
...
<p align="center">
  <img width="auto" height="300" src="images/lesson3/overall.png">
</p>
...
![](images/lesson3/serper_api_key.png)
...
![Image](images/lesson3/remote.png)
